...
class OpencartTestHelper
{
    ...
    public $checkout_mode = 'after_order';
    ...
    /**
     * OpencartTestHelper constructor.
     *
     * @param \Opencart\OpencartTest|\Opencart\OpencartFullTest $opencart_test
     */
    public function __construct($opencart_test)
    {
        $this->main_test    = $opencart_test;
        $this->wd           = $opencart_test->wd;
